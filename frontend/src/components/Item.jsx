  ...
  return (
    <div className="bottom-12 relative">
      ...
      <Link
        ...
        className="flexCenter relative top-12  
        overflow-hidden m-2.5 rounded-xl"
      >
      ...
      <div className="p-3 rounded-lg pt-12 bg-white shadows">
        ...
        <div className="flexBetween pt-1">
          <h5 className="h5 pr-2">KSH:{product.price}.00</h5>
          <div className="flex items-baseline gap-x-1">
            <FaStar className="text-secondary" />
            <h5 className="h5 relative bottom-0.5">4.0</h5>
          </div>
        </div>
