...
import { FaArrowRight, FaStar, FaStarHalfStroke, FaTruckFast } from "react-icons/fa6";
...
const Product = () => {
  ...
  if(!product){
    return <div>...Getting items bruv!!!</div>
  }
          ...
          <div className='flex-[1.5] rounded-2xl xl:px-7'>
            ...
            <div className='flex items-baseline gap-x-5 '>
              <div className='flex items-center gap-x-2 text-secondary'>
                ...
                <span className='medium-14'>(111)</span>
              </div>
            </div>
            <h4 className='h4 my-2'>{currency}{product.price}</h4>
            ...
            <div className='flex items-center gap-x-2 mt-3'>
              ...
              <span className='medium-14'>Free delivery on orders over Ksh:6000</span>
            </div>
            <hr className='my-3 w-2/3'/>
            <div className='mt-2 flex flex-col gap-1 text-gray-30 text-[14px]'>
              <p>Trusted authenticity.</p>
              <p>Enjoy easy Cash on Delivery.</p>
