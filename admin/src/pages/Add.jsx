...
const Add = ({ token }) => {
  ...
  const [subCategory, setSubCategory] = useState("Awesome");
            ...
            <div className="flex flex-row gap-4">
              <div>
                ...
                <select
                  ...
                  className="max-w-26 px-3 py-2 text-gray-30 right-1 ring-slate-900/5 bg-white rounded"
                >
              ...
              <div>
                ...
                <select
                  ...
                  className="max-w-28 px-3 py-2 text-gray-30 right-1 ring-slate-900/5 bg-white rounded"
                >
          ...
          <div className="flex gap-3 mt-2">
            ...
            >
              <span
                ...
                } rounded ring-1 ring-slate-900/5 px-3 py-1 cursor-pointer`}
              >
                S
              </span>
            </div>
